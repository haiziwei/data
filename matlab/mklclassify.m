function [result, weights] = mklclassify(xapp, yapp, xtest, ytest, C, num1,num2)
...
%nbtrain=floor(nbdata*ratio);
    ...
    kerneloptionvect = {[0.0625 0.1 0.2 0.5 1 2 5 7 10 12 15 17 20] [0.0625 0.1 0.2 0.5 1 2 5 7 10 12 15 17 20] [0.0625 0.1 0.2 0.5 1 2 5 7 10 12 15 17 20]};%We can change the parameters to achieve better results
    variableveccell = { [1:num1] [num1+1:num1+num2] [num1+num2+1:dim]};
